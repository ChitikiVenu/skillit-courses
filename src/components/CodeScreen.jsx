...
// A code editor that never stops typing. One endless script is typed out character by character,
// snippet after snippet (one per programme), scrolling up like a real editor as it fills. It is
// never cleared: when the section scrolls out of view the typing pauses and picks up exactly where
// it left off. Line width is kept to ~34 characters so it fits the tablet screen at every size.
const SNIPPETS = [
  {
    file: 'career.js',
