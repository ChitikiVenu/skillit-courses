      ...
      <section className="hero">
        <div className="wrap">
          ...
          <p className="hero-lede">
            Hands-on training in Cyber Security, AI &amp; ML, Data Science, SOC Analyst and Data Analytics,
            in Hyderabad. Every programme includes labs, projects and a real-time internship.
          </p>
